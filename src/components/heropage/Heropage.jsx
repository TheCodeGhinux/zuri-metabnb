    ...
    <section id='heropage' >
        <div className="flex flex-col gap-4 justify-between items-center container mx-auto py-8 px-4 md:px-12 md:flex-row ">
            <div className="flex flex-col gap-8 md:w-1/2">
                  <h2 className='text-4xl'>Rent a <span className='text-purple font-bold'>Place</span> away from <span className='text-purple font-bold'>Home</span> in the <span className='text-purple font-bold'>Metaverse</span></h2>
